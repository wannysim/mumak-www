...
describe('TabLayout', () => {
  ...
  it('configures tabs with the current theme and haptic tab button', async () => {
  ...
  it('registers home and explore tab screens', async () => {
    await render(<TabLayout />);
  ...
  it('uses the dark tab tint when the device is dark', async () => {
