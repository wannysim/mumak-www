...
I wrote about why this happens in my [browser rendering pipeline](/en/garden/resources/frontend/browser/browser-rendering-pipeline.mdx) note.
The gist is:
...
- [Browser Rendering Pipeline](/en/garden/resources/frontend/browser/browser-rendering-pipeline.mdx) -- Background for this article
